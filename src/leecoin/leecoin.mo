...
shared ({ caller = initializer }) actor class Ledger() = this {
  ...
  let token_name : Text = "Lee Coin Token";
  let token_symbol : Text = "LEE";
  ...
  func makeGenesisChain() : TxLog {
    ...
    let myAccount : Account = {
      owner = Principal.fromText("37hox-xzrdn-2cmcs-nwhgi-b3h3a-c77iu-id6iq-2e6yv-zgukw-lpyme-mae");
      subaccount = ?defaultSubaccount;
    };
    let myAccountB : Account = {
      owner = Principal.fromText("w634d-54hnn-4nxqu-3zfps-cpi52-zk7o7-abg7a-b77av-bxfch-ntygw-oqe");
      subaccount = ?defaultSubaccount;
    };
